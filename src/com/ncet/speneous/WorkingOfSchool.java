...
public class WorkingOfSchool {
	...
	public static void main(String[] args) 
	{
		...
		while(true)
		{
			...
			switch(c)
			{
			case 1:boolean s =w1.AddSchool();
			if(s) {
				System.out.println("School is add sucessfully");
			}
			break;
				case 5: w1.DeleteSchool(1);
    	 break;
    	 case 3:w1.UpdateSchool(); 
    	 break;
    	 case 4:w1.GetSchool(1);
    	 break;
			case 2:w1.ListOfSchool();
			break;
          default:System.out.println("Hello! Boos give proper input ");
          break;
			}
		}		
	}		
